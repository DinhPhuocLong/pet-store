<template>
    <div v-if="products.length">
        <div class="flex mt-10 w-[94%] max-w-[1440px] xl:w-11/12 mx-auto mb-20">
            ...
            <div class="w-full lg:w-3/4">
                <div
                    class="w-[94%] xl:w-11/12 mx-auto items-center flex justify-between lg:justify-between gap-x-2"
                >
                    <div>
                        Tìm thấy <b>{{ total }}</b> sản phẩm với từ khoá "<b>{{ key }}</b>" 
                    </div>
                    <div
                    ...
                    <div class="relative flex gap-x-2">
                        ...
                        <div class="">
                            <select
                                ...
                                style="width: 150px"
                            >
                                <option class="pt-6">Mặc định</option>
                                <option>100.000đ - 200.000đ</option>
                                <option>200.000đ - 300.000đ</option>
                                <option>300.000đ - 1.000.000đ</option>
                            </select>
                            <div
    ...
    <div
        v-else
        class="flex mt-10 w-[94%] max-w-[1440px] justify-center xl:w-11/12 mx-auto mb-20"
    >
        Không tìm thấy sản phẩm nào với từ khoá <b class="ml-2">"{{ key }}"</b>
    </div>
</template>
...
export default {
    ...
    methods: {
        getProducts() {
            ...
            this.$axios.get(process.env.BASE_URL + '/search', 
                { params: query }
            ).then(
                products => {
