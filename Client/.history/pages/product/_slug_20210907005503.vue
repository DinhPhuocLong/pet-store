                        ...
                        <div class="border-b border-solid border-gray-300 pb-8">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <button
                                        class="flex-grow h-12 bg-gray-800 text-white rounded-full hover:bg-gray-700"
                                    >
                                        Thêm vào giỏ
                                    </button>
                                </div>
                                <button
                                    style="flex: 1 0 calc(50% - 65px);"
                                    class="h-12 text-white bg-red-500 rounded-full mt-4 [480]:mt-0 hover:bg-red-600"
                                >
                                    Mua ngay
                                </button>
                            </form>
