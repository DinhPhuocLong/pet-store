                ...
                <div class="lg:w-1/2">
                    ...
                    <div class="grid grid-cols-4 gap-x-4 mt-4">
                        <div
                            ...
                            :key="index"
                            @click="handleChangeImage($event, index)"
                            class="border border-solid border-black rounded-lg overflow-hidden cursor-pointer"
                        >
...
export default {
    ...
    computed: {
        ...
        getChangeImage() {
            let index = this.selectedImage;
            return this.product.product.product_images[index];
        }
    },
    methods: {
