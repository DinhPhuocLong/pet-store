    ...
    <form class="flex flex-1 justify-center relative">
        ...
        <div class="w-full absolute top-14 bg-white shadow-md" style="z-index: 9999;">
            <div class="overflow-y-scroll" style="height: 400px" v-if="suggests.length">
                <div class="flex items-center justify-between my-2 p-2 hover:bg-gray-200 cursor-pointer border border-gray-200" v-for="item in suggests" :key="item.id">
                    <div class="w-1/5 flex items-center justify-center mx-auto">
                        <img class="w-12 p-2 border-red-500 border" src="http://localhost:8000/storage/images/thuoc-nho-gay-cho-meo-thu-gian-beaphar-calming-300x300.jpg">
                    </div>
                    <div class="w-3/5">
                        <a href="#">
                            {{ item.name }}
