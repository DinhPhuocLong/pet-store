<template>
    <form class="flex flex-1 justify-center relative">
        ...
        <div class="w-full absolute top-0 px-4 bg-white shadow-md rounded-full">
            <div class="flex item-center justify-between">
                <div class="w-1/5">
                    <img class="w-full" src="http://localhost:8000/storage/images/thuoc-nho-gay-cho-meo-thu-gian-beaphar-calming-300x300.jpg" alt="">
                </div>
                <div class="w-4/5">
                    <p>
