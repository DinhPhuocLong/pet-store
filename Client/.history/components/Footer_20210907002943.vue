            ...
            <div class="w-[94%] xl:w-11/12 max-w-[1440px] mx-auto mt-4">
                <div class="grid md:grid-cols-2 lg:grid-cols-4 md:items-end lg:items-start">
                    ...
                    <div class="mt-10 md:mt-0 md:mb-10">
                        <p class="text-black font-bold text-lg py-4">Thông tin Pet-Market</p>
                        <div class="flex flex-col justify-center items-center text-yellow-600">
                            <div class="flex flex-col md:flex-row md:items-center mb-2">
                                ...
                                <span class="text-black text-sm font-bold">Đường Hậu Giang, Phường 9, Quận 6, TP. Hồ Chí Minh</span>
                            </div>
                    ...
                    <div class="mt-10 md:mt-0 md:mb-10">
                        <p class="text-black font-bold text-lg py-4">Dịch vụ</p>
                    ...
                    <div class="mt-10 md:mt-0 md:mb-10">
                        <p class="text-black font-bold text-lg py-4">Về chúng tôi</p>
