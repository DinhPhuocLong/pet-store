                ...
                <div class="w-[94%] xl:w-11/12 max-w-[1440px] mx-auto mt-4">
                    ...
                    >
                        <div class="md:mb-10">
                            ...
                            <p
                                class="text-[13px] font-bold italic text-justify"
                            >
                                Cửa hàng PetMarket có rất nhiều mặt hàng cho thú
                                cưng cần như: thức ăn, quần áo, đồ chơi... Không
                                những có những thứ thiết yếu cửa hàng còn có
                                nhiều dịch vụ chăm sóc sức khỏe và sắc đẹp cũng
                                như chia sẻ những thứ hữu ích đến những người
                                nuôi thú cưng.
                            </p>
                        ...
                        <div class="mt-10 md:mt-0 md:mb-10">
                            <p
                                class="text-black text-center lg:text-left font-bold text-lg py-4"
                            >
                                Thông tin Pet-Market
                            </p>
                            <div
                                class="flex flex-col justify-center text-yellow-600"
                            >
                                <div
                                ...
                                >
                                    ...
                                    <span class="text-black text-sm font-bold"
                                        >Đường Hậu Giang, Phường 9, Quận 6</span
                                    >
                                </div>
                                <div
                                    class="flex flex-col md:flex-row items-center md:items-start mb-2"
                        ...
                        <div class="mt-10 md:mt-0 md:mb-10">
                            <p
                                class="text-black font-bold text-lg py-4 text-center lg:text-left"
                            >
                                Dịch vụ
                            </p>
                        ...
                        <div class="mt-10 md:mt-0 md:mb-10">
                            ...
                            <ul
                                class="text-gray-400 tracking-tight text-base font-normal text-center lg:text-left"
                            >
