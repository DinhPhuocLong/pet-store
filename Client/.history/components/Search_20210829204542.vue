<template>
    <form class="flex flex-1 justify-center relative">
        ...
        >
            ...
            >
                <div
                    class="flex items-center justify-between p-2 hover:bg-gray-200 cursor-pointer border-b"
                    v-for="item in suggests"
                    :key="item.id"
                >
                    <div
                        class="w-full lg:w-1/5 flex items-center justify-center mx-auto"
                    >
                        <img
                            class="w-12"
                    ...
                    <div class="w-1/5 text-red-500 text-center">
                        <span class="text-center">
                            ...
                            {{
                                calSalePrice(item.price, item.salePrice)
                                    | toVndCurrency
                            }}
                        </span>
                    </div>
            ...
            <div v-else>
                <h2 class="p-2 bg-black text-white uppercase">
                    Lịch sử tìm kiếm
                </h2>
                <div
