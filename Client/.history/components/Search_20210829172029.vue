<template>
    <form class="flex flex-1 justify-center">
        <div class="relative">
            ...
            <div
                class="w-full absolute top-14 p-2 bg-white shadow-md rounded-full"
            >
                <div class="flex items-center justify-between">
                    <div class="w-1/5 flex items-center justify-center mx-auto">
                        <img
                            class="w-12"
                            src="http://localhost:8000/storage/images/thuoc-nho-gay-cho-meo-thu-gian-beaphar-calming-300x300.jpg"
                        />
                    </div>
                    <div class="w-4/5">
                        <p>
