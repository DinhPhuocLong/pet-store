<template>
    <form class="flex flex-1 justify-center relative">
        ...
        <div class="w-full absolute top-14 p-2 bg-white shadow-md" style="z-index: 9999;">
            <div class="flex items-center justify-between my-2" v-if="suggests.length">
            ...
            <div v-else>
                ...
                <div class="flex justify-between items-center my-2" v-for="item in suggests" :key="item.id">
                    <div>
