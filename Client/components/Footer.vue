                    ...
                    >
                        <div class="md:mb-10">
                            ...
                            <div class="flex flex-col text-yellow-600">
                                <div
                                    class="flex flex-col md:flex-row md:items-center justify-center lg:justify-start mb-2"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="24"
                                ...
                                <div
                                    class="flex flex-col md:flex-row md:items-center justify-center lg:justify-start mb-2 md:mb-0"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="24"
