<template>
    ...
    >
        <div class="w-full h-20 border-b flex px-4 items-center mb-8">
            <nuxt-link to="/"><img src="../static/logo.png" alt="" width="100%"></nuxt-link>
        </div>
        ...
        <div class="mb-4 px-4">
            ...
            >
                ...
                <nuxt-link to="/category" class="text-gray-700"
            ...
            >
                ...
                <nuxt-link :to="{ name: 'category', query: { type: 'product' } }" class="text-gray-700"
            ...
            >
                ...
                <nuxt-link :to="{ name: 'category', query: { type: 'blog' } }" class="text-gray-700"
